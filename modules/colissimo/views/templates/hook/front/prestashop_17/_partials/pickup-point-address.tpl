...
{else}
    ...
    <article id="colissimo-pickup-point-address-selected">
      ...
      <header>
        ...
        <div class="colissimo-pickup-point-address">
          ...
          <p class="colissimo-mobile-invalid js-colissimo-mobile-invalid lbg-text-error">
            {l s='Veuillez renseigner un numéro valide' d='Modules.Colissimo.Pickup-point-address'}
          </p>
  ...
  {else}
    <button type="button" class="lbg-btn primary-btn-full" id="colissimo-select-pickup-point" name="colissimoSelectPickupPoint"
            value="1">
