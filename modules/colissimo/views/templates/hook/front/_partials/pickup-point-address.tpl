...
{else}
    ...
    <article id="colissimo-pickup-point-address-selected">
      ...
      <header>
        ...
        <div class="colissimo-pickup-point-address">
          ...
          <input type="tel" class="fixed-width-md colissimo-pickup-mobile-phone" id="colissimo-pickup-mobile-phone"
            value="{$mobile_phone}" name="colissimo_pickup_mobile_phone[main]" onkeyup="blockFixedNumber()" />
          <img src="{$colissimo_img_path}icons/icon_valid.png" class="colissimo-mobile-valid js-colissimo-mobile-valid" />
  ...
  {else}
    {* <button type="button" class="border-2 border-lbg-primary text-lbg-primary text-sm py-2 px-12 rounded-sm" id="colissimo-select-pickup-point" name="colissimoSelectPickupPoint" *}
    <button type="button" class="bg-lbg-primary hover:bg-primary text-white text-sm py-2 px-12 rounded-sm"
      id="colissimo-select-pickup-point" name="colissimoSelectPickupPoint" value="1">
      {l s='Sélectionner un point relais' mod='colissimo'}
    </button>
  {/if}
{/if}