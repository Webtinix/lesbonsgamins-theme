...
{if isset($customs_fees) && $customs_fees}
    {if isset($check_ddp) && $serviceType == 'SANS_SIGNATURE'}
    {else}
        <p class="alert alert-warning"><strong>{l s='Delivery includes %s %s customs fees'  sprintf=[$customs_fees, $currency] mod='colissimo'}</strong></p>
    {/if}
{/if}
