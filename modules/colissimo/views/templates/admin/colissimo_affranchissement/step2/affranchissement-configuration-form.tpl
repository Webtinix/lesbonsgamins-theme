...
{if $orders}
  ...
  {if $colissimo_ddp}
    <div class="alert alert-info colissimo-package-text">
        {l s='For a package in DDP please fill in the dimensions and the description in English by unfolding the order with the ' mod='colissimo'}<span class="col-reference-plus"><i class="icon icon-plus-circle"></i></span>
    </div> 
  {/if}
