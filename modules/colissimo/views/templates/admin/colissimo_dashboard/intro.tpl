...
<div class="alert alert-info colissimo-dashboard-intro">
  ...
  <p>
    {l s='Automatically, ask your hosting provider or your administrator to setup a "Cron Task" to load the following URL at the time you would like:' mod='colissimo'}
  </p>
