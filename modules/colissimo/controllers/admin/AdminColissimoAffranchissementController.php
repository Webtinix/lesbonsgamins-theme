...
class AdminColissimoAffranchissementController extends ModuleAdminController
{
    ...
    public function initStep2($selection)
    {
        ...
        $this->context->smarty->assign(
            array('orders' => $data, 'img_path' => $this->module->getPathUri().'views/img/', 'colissimo_ddp' => $colissimoDDP, 'insurance_msg' => $insuranceMsg)
        );
    ...
    */
    public function processUploadCustomsDocumentsFiles($idLabel, $type)
    {
        try {
            ...
            $file = array();
            $file['name'] = $type;
            $file['content'] =  base64_encode(Tools::file_get_contents($safeDestination));
