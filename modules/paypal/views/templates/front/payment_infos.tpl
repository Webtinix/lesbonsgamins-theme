...
<div data-paypal-info class="pp__pl-2 pp__d-table-cell" style="display: none">
 <a href="#"
    ...
    data-content=""
 >
 <svg class="ml-1" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 21 22">
   <g id="Groupe_2937" data-name="Groupe 2937" transform="translate(-1198.999 -748)">
     <g id="Ellipse_261" data-name="Ellipse 261" transform="translate(1198.999 749)" fill="none" stroke="#191310" stroke-width="1">
       <circle cx="10.5" cy="10.5" r="10.5" stroke="none"/>
       <circle cx="10.5" cy="10.5" r="10" fill="none"/>
     </g>
     <text id="i" transform="translate(1206.999 766)" fill="#191310" font-size="17" font-family="SegoeUI, Segoe UI"><tspan x="0" y="0">i</tspan></text>
   </g>
 </svg>
 </a>
</div>
