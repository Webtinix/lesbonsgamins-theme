...
{block name='address_selector_blocks'}
  ...
  {foreach $addresses as $address}
    {* <article class="bg-gray-100 rounded-lg w-full pt-4 md:pt-3 pb-6 {if $address.id == $selected} border selected{/if}" id="{$name|classname}-address-{$address.id}"> *}
    <article
      class="bg-gray-100 rounded-lg w-full pt-4 md:pt-3 pb-6 js-address-item address-item{if $address.id == $selected} selected{/if}"
    ...
    >
      ...
      <div class="pl-10 pr-4 flex justify-between">
        <div class="flex-1 -mt-5 md:mt-0">
          <p class="text-lg font-medium mb-2">{$address.alias}</p>
          <div class="address text-sm">{$address.formatted nofilter}</div>
        </div>
        <div class="flex flex-col justify-between pb-2">
          <a 
            data-link-action="edit-address"
            href="{url entity='order' params=['id_address' => $address.id, 'editAddress' => $type, 'token' => $token]}" 
            title="Modifier" class="edit-address group"
          >
            <svg class="inline-block group-hover:hidden" xmlns="http://www.w3.org/2000/svg" width="19.539" height="19.373" viewBox="0 0 19.539 19.373">
              <defs>
            ...
            <svg class="hidden group-hover:inline-block" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="19.539" height="19.373" viewBox="0 0 19.539 19.373">
              <defs>
                <clipPath id="clip-path">
          ...
          <a 
            ...
            title="Supprimer" class="delete-address group"
          > 
            <svg xmlns="http://www.w3.org/2000/svg" class="inline-block group-hover:hidden" width="19.715" height="25.487" viewBox="0 0 19.715 25.487">
              <defs>
                <clipPath id="clip-path">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" class="hidden group-hover:inline-block" width="19.715" height="25.487"  viewBox="0 0 19.715 25.487">
              <g id="Groupe_3056" data-name="Groupe 3056" transform="translate(0 0)">
                <g id="Groupe_3052" data-name="Groupe 3052" transform="translate(0 0)">
